...
export const componentLogs = [
  ...
  `For more info, Visit: ${SERVERCN_URL}/components`
];
export const foundationLogs = [
  ...
  `For more info, Visit: ${SERVERCN_URL}/foundations`
];
export const blueprintLogs = [
  ...
  `For more info, Visit: ${SERVERCN_URL}/blueprints`
];
export const schemaLogs = [
  ...
  `For more info, Visit: ${SERVERCN_URL}/schemas`
];
export const toolingLogs = [
  ...
  `For more info, Visit: ${SERVERCN_URL}`
];
