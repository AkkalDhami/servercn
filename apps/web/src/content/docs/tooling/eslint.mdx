...
command: npx servercn add tooling eslint
---
...
<PackageManagerTabs command="npx servercn add tooling eslint" />
...
<PackageManagerTabs command="npx servercn add tooling commitlint husky eslint prettier lint-staged typescript " />