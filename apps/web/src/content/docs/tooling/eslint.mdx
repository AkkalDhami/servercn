...
command: npx servercn-cli@latest add tl eslint
---
...
<PackageManagerTabs command="npx servercn-cli@latest add tl eslint" />
...
* <Code>eslint-plugin-prettier</Code> - ESLint plugin for Prettier formatting
...
<PackageManagerTabs command="npx servercn-cli@latest add tl commitlint husky eslint prettier lint-staged typescript " />