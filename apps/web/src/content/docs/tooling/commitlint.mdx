...
command: npx servercn-cli@latest add tl commitlint
---
...
<PackageManagerTabs command="npx servercn-cli@latest add tl commitlint" />
...
<PackageManagerTabs command="npx servercn-cli@latest add tl husky" />
