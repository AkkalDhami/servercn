...
command: npx servercn add tooling lint-staged
---
...
<PackageManagerTabs command="npx servercn add tooling lint-staged" />

## Configuration

The component adds a <Code children="lint-staged" /> configuration to your <Code children="package.json" /> or creates a <Code children=".lintstagedrc" /> file.
