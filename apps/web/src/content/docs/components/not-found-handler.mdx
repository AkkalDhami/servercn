...
command: npx servercn add not-found-handler
          ...
          - type: file
            ...
            content: |
              ...
              export const notFoundHandler = (
                ...
                throw ApiError.notFound(<Code children="Route ${req.method} ${req.originalUrl} not found" />);
              };
...
<PackageManagerTabs command="npx servercn add not-found-handler" />
