...
```ts
const isValid = verifyOTP("123456", "8958319959f69db8f78e94c0f3bba4df00f01744769c88d459ff189793bd4fa3"); //? true if valid, false otherwise
```
...
```ts
const isValid = verifyHashedToken("my-token", "8958319959f69db8f78e94c0f3bba4df00f01744769c88d459ff189793bd4fa3"); // true if valid, false otherwise
```
