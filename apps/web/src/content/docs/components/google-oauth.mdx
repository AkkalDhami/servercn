...
- <Code children="https://www.googleapis.com/auth/userinfo.email" /> - User's
  email address
- <Code children="https://www.googleapis.com/auth/userinfo.profile" /> - User's
  basic profile info
- <Code children="https://www.googleapis.com/auth/user.birthday.read" /> -
  User's birthday
- <Code children="https://www.googleapis.com/auth/user.phonenumbers.read" /> -
  User's phone numbers
- <Code children="https://www.googleapis.com/auth/calendar.readonly" /> -
