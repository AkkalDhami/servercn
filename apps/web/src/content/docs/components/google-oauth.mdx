            ...
            content: |
              ...
              export async function getGoogleUserInfo(accessToken: string) {
                ...
                const userInfoResponse = await fetch(
                  ...
                  {
                    headers: {
                      Authorization: <Code children="Bearer ${accessToken}" />,
                    },
                  }
                );
...
**_👉 Note:_** _You do not need to install any dependencies manually. Installing this component will automatically install all required dependencies. Manual installation is optional if you prefer to manage dependencies yourself._
...
6. Create OAuth 2.0 Client ID:
   ...
   - Authorized redirect URIs: Add your callback URL (e.g., <Code children="http://localhost:8000/api/auth/google/callback" />)
...
<Code children="src/configs/env.ts" /> || <Code children="src/shared/configs/env.ts" />
...
Place the Google OAuth utilities in <Code children="src/utils/google-oauth.ts" />:
...
For feature-based architecture, place helpers in <Code children="src/modules/auth/google-oauth.helpers.ts" />:
...
- <Code children="https://www.googleapis.com/auth/userinfo.email" /> - User's email address
- <Code children="https://www.googleapis.com/auth/userinfo.profile" /> - User's basic profile info
- <Code children="https://www.googleapis.com/auth/user.birthday.read" /> - User's birthday
- <Code children="https://www.googleapis.com/auth/user.phonenumbers.read" /> - User's phone numbers
- <Code children="https://www.googleapis.com/auth/calendar.readonly" /> - Read-only access to user's calendar
