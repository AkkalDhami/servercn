            ...
            content: |
              ...
              export const validateRequest = (schema: ValidationSchema) => {
                return (req: Request, res: Response, next: NextFunction) => {
                  try {
                    const validationTargets: ValidationTarget[] = ["body", "query", "params"];
        ...
        children:
          - type: file
            ...
            content: |
              ...
              router.get("/", validateRequest(listUsersSchema), (req, res) => {
                return res.json({ success: true, data: req.query });
              });

              router.get("/:id", validateRequest(getUserSchema), (req, res) => {
                return res.json({ success: true, data: req.params });
              });

              router.put("/:id", validateRequest(updateUserSchema), (req, res) => {
                return res.json({ success: true, data: { params: req.params, body: req.body } });
              });
