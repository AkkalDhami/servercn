    ...
    children:
      ...
      - type: file
        ...
        content: |
          ...
          app.listen(PORT, () => {
            logger.info(<Code children="Server is running on http://localhost:${PORT}" />);
          });
...
<Code children="src/services/cloudinary.service.ts" /> or <Code children="src/utils/cloudinary.ts" /> or <Code children="src/helpers/cloudinary.ts" />
...
<Code children="src/controllers/upload.controller.ts" />
...
<br />
<Code children="src/routes/upload.routes.ts" />
