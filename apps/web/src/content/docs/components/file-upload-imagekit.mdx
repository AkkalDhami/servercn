...
**_👉 Note:_** _You do not need to install any ServerCN dependencies manually.
Running the File Upload installer will automatically install all required dependencies.
Manual installation is optional and only recommended if you prefer fine-grained dependency control._
