---
title: GitHub & Google OAuth (NextAuth)
description: Production-ready GitHub & Google OAuth service for authentication in Servercn using NextAuth with support for multiple providers (Google, GitHub, etc.).
