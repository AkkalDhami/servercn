---
title: GitHub OAuth (NextAuth)
description: Production-ready GitHub OAuth service for authentication in Servercn using NextAuth with support for multiple providers (Google, GitHub, Facebook, etc.).
