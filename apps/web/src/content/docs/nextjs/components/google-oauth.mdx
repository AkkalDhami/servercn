...
command: npx servercn-cli@latest add google-oauth
---
...
You will be prompted to select an OAuth provider:
...
#### Add the <Code>SessionProvider</Code> to the root of your app.
