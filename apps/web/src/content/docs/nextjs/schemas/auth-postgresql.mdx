...
# Auth Domain (PostgreSQL with Drizzle)
...
<Code children="src/db/schemas/otp.schema.ts" />
...
<Code children="src/db/schemas/session.schema.ts" />
...
<Code children="src/db/schemas/refresh-token.schema.ts" />
...
<Code children="drizzle.config.ts" />
...
export default defineConfig({
  out: "./src/db/migrations", // Directory where migrations are generated
  schema: "./src/db/index.ts", // Central schema entry point
