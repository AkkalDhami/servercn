...
1. **[MongoDB (Mongoose)](/docs/nextjs/schemas/todo-mongodb)** - Using Mongoose models with full type safety.
2. **[PostgreSQL (Drizzle)](/docs/nextjs/schemas/todo-postgresql)** - Type-safe Drizzle schemas for PostgreSQL.
3. **[MySQL (Drizzle)](/docs/nextjs/schemas/todo-mysql)** - Type-safe Drizzle schemas for MySQL.
...
**View Documentation: [MongoDB](/docs/nextjs/schemas/todo-mongodb) | [PostgreSQL](/docs/nextjs/schemas/todo-postgresql) | [MySQL](/docs/nextjs/schemas/todo-mysql)**

## Relationship Design

The Todo schema is designed to work seamlessly with the [Auth Domain](/docs/nextjs/schemas/auth). It maintains a one-to-many relationship:
...
- [MongoDB (Mongoose) Implementation](/docs/nextjs/schemas/todo-mongodb)
- [PostgreSQL (Drizzle) Implementation](/docs/nextjs/schemas/todo-postgresql)
- [MySQL (Drizzle) Implementation](/docs/nextjs/schemas/todo-mysql)
- [Auth Domain Schemas](/docs/nextjs/schemas/auth)
