...
<Note text={"REST APIs use nouns in URLs and actions are defined by HTTP methods."} />
...
<Note text={"Status codes help clients understand the result without parsing the response body."} />
