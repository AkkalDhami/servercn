...
<PackageManagerTabs command="npx servercn-cli init <foundation-name>" />
...
```
Usage: servercn-cli add [options] <components...>

Add one or more backend components to your project

Options:
  --arch <arch>  Project architecture: mvc or feature (default: "mvc")
  -f, --force    Force overwrite existing files
  --local        Add registry items from local environment(development runtime)
