...
[Prisma Official Docs](https://www.prisma.io/docs/orm/overview/databases/mysql)
...
- MySQL models managed via Prisma
...
## Sync your schema to MySQL

Use db push to sync your schema with your MySQL database:
