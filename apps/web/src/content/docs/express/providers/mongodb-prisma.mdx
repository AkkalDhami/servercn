...
description: This provider sets up MongoDB connectivity with Prisma for Express projects, including environment validation, a Prisma client configuration, and a starter schema.
