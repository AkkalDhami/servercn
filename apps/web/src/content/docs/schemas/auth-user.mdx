...
command: npx servercn add schema auth/user --variant=advanced
...
<PackageManagerTabs command="npx servercn add schema auth/user --variant=minimal" />

  - <Code children={'--variant=advanced'} /> -> full production-ready schema (default)
<PackageManagerTabs command="npx servercn add schema auth/user --variant=advanced" />
