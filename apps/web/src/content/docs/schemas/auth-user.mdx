...
command: npx servercn add model auth/user --variant=advanced
...
<PackageManagerTabs command="npx servercn add model auth/user" />

This command generates the User schema based on your existing <Code children={'servercn.json'} /> configuration.

### Configuration & Overrides

By default, the CLI uses the configuration defined in your <Code children={'servercn.json'} /> file (typically initialized during `npx servercn init`). It will automatically detect your project's **Database**, **Architecture**, and **Language**.

If you wish to override these defaults, you can use the following flags:

- **Variant**:
  - <Code children={'--variant=minimal'} /> -> lightweight schema
    <PackageManagerTabs command="npx servercn add model auth/user --variant=minimal" />

  - <Code children={'--variant=advanced'} /> -> full production-ready schema (default)
    <PackageManagerTabs command="npx servercn add model auth/user --variant=advanced" />

- **Database**:
  - <Code children={'--db=mongodb'} /> -> MongoDB (default)
    <PackageManagerTabs command="npx servercn add model auth/user --db=mongodb" />

  - <Code children={'--db=mysql'} /> -> MySQL
    <PackageManagerTabs command="npx servercn add model auth/user --db=mysql" />

  - <Code children={'--db=pg'} /> -> PostgreSQL
    <PackageManagerTabs command="npx servercn add model auth/user --db=pg" />
...
<PackageManagerTabs command="npx servercn add model auth/user --variant=minimal --db=mongodb" />
...
<PackageManagerTabs command="npx servercn add model auth/user --variant=advanced --db=mongodb" />
...
<PackageManagerTabs command="npx servercn add model auth/user --variant=minimal --db=mysql" />  
...
<PackageManagerTabs command="npx servercn add model auth/user --variant=advanced --db=mysql" />
...
<PackageManagerTabs command="npx servercn add model auth/user --variant=minimal --db=pg" />
