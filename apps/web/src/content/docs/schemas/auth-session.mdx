...
command: npx servercn-cli add schema auth/session
...
This command generates the Session schema based on your existing <Code children={'servercn.config.json'} /> configuration.
