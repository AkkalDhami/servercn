...
- <Code children="env.DATABASE_URL" /> should be validated via Env Configuration before use.
- <Code children="strict: true" /> helps catch schema issues early during migration generation.
