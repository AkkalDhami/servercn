...
After initialization, ServerCN creates a <Code children="servercn.json" /> file in your project root:
...
You can manually edit <Code children="servercn.json" /> to change your project configuration:
...
1. Check for <Code children="servercn.json" /> in your project root
...
- Your project already has a <Code children="servercn.json" /> file
- You can start adding components immediately
- To reinitialize, delete <Code children="servercn.json" /> first
...
1. Ensure TypeScript is installed: <Code children="npm install -D typescript @types/node" />
2. Check <Code children="tsconfig.json" /> exists and is properly configured
...
1. Check your <Code children="servercn.json" /> architecture setting
...
- **Documentation**: Check component-specific docs in <Code children="/docs/components/" />
...
1. Delete <Code children="servercn.json" /> configuration file
