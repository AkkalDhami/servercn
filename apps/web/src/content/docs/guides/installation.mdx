...
<PackageManagerTabs command="npx servercn-cli add jwt-utils http-status-codes logger-pino" />
...
2. Run <Code children="npx servercn-cli list" /> to see available components
3. Try adding a component: <Code children="npx servercn-cli add error-handler" />
...
npx servercn-cli add error-handler  # ✅ Correct
npx servercn-cli add errorhandler   # ❌ Incorrect
```
