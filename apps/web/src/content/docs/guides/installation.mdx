...
- Migration scripts and configuration for `drizzle-kit`.
...
<Note text={"Note: ServerCN doesn't install itself as a runtime dependency. Components are copied into your codebase, so you own the code completely."} />
