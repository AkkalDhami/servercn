...
#### <Code children="constants/" />

Application-wide constants:

```ts
// src/constants/status-codes.tsexport const STATUS_CODES = {
  OK: 200,
  CREATED: 201,
  BAD_REQUEST: 400,
  UNAUTHORIZED: 401,
...
Feature-based architecture organizes code by **features** or **modules**. Each feature is self-contained with its own controllers, services, models, and routes. Shared code lives in a <Code children="shared/" /> directory.
...
#### <Code children="shared/" />

Code shared across all features:

- **<Code children="shared/configs/" />**: Application configuration
- **<Code children="shared/constants/" />**: Shared constants
- **<Code children="shared/errors/" />**: Error classes and handlers
- **<Code children="shared/middlewares/" />**: Global middlewares
- **<Code children="shared/utils/" />**: Shared utility functions

<br />

#### <Code children="modules/" />

Self-contained feature modules. Each module contains:

- **<Code children="controllers/" />**: Feature-specific controllers
- **<Code children="services/" />**: Feature-specific business logic
- **<Code children="models/" />**: Feature-specific database models
- **<Code children="routes/" />**: Feature-specific routes
- **<Code children="validations/" />**: Feature-specific validation schemas
- **<Code children="types/" />**: Feature-specific TypeScript types

<br />

#### <Code children="routes/index.ts" />
...
| -------------- | ------------------------------------------- |
| Middlewares    | <Code children="src/middlewares/" />        |
| Utilities      | <Code children="src/utils/" />              |
| Constants      | <Code children="src/constants/" />          |
| Errors         | <Code children="src/utils/" /> (as utility) |
| Validations    | <Code children="src/validations/" />        |

### Feature-Based Architecture

| Component Type | Location                                               |
| -------------- | ------------------------------------------------------ |
| Middlewares    | <Code children="src/shared/middlewares/" />            |
| Utilities      | <Code children="src/shared/utils/" />                  |
| Constants      | <Code children="src/shared/constants/" />              |
| Errors         | <Code children="src/shared/errors/" />                 |
| Validations    | <Code children="src/modules/{feature}/validations/" /> |
...
Put reusable code in <Code children="shared/" />:
...
1. **Update <Code children="servercn.json" />**:
...
Your architecture choice is stored in <Code children="servercn.json" />:
