...
const features: IFeature[] = [
  ...
  },
  {
    ...
    description:
      "ServerCN copies code directly into your project. No runtime dependencies. No lock-in.",
  },
  {
    icon: Layers,
...
export function FeatureCard({ item }: { item: IFeature }) {
  return (
    <div
      key={item.title}
      className="hover:bg-card-hover bg-background border-hover rounded-xl border p-6"
    >
