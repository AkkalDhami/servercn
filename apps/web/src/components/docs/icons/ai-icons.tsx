...
import { AI_QUERIES } from "@/lib/constants";
...
export const Icons = {
  ...
  googleAiStudio: (props: IconProps) => (
    <svg
      ...
      <defs>
        <clipPath id="prefix__clip0_5_13">
...
const aiIconMap: Readonly<Record<AiName, React.ComponentType<IconProps>>> = {
  ...
  claude: Icons.claude,
  "google-ai-studio": Icons.googleAiStudio,
