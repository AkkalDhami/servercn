...
export const mdxComponents: MDXComponents = {
  ...
  code: props => <code className="bg-muted-foreground rounded px-1 py-0.5 text-sm" {...props} />,
  ...
  ul: props => <ul className="text-muted-primary list-dics space-y-3 pl-2" {...props} />,
